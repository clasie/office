...
class CalculateurModel extends Db {
    const TABLE_PROVIDER = 'users_tuto_provider';
    const TABLE_TYPE_BETON = 'calc_type_beton';
    const TABLE_TYPE_FERAILLAGE = 'calc_type_feraillage';
    const TABLE_TYPE_QUARTZ = 'calc_type_quartz';    
    private $search = "";
    ...
    public function getTypeBeton(){
        $sql = "SELECT * FROM " . CalculateurModel::TABLE_TYPE_BETON . "";
        //$res = mysql_query($sql);
        $res = mysqli_query($this->con,$sql);
        return $res;
    }
    public function getTypeFeraillage(){
        $sql = "SELECT * FROM " . CalculateurModel::TABLE_TYPE_FERAILLAGE . "";
        $res = mysqli_query($this->con,$sql);
        return $res;
    }
    public function getTypeQuartz(){
        $sql = "SELECT * FROM " . CalculateurModel::TABLE_TYPE_QUARTZ . "";
        $res = mysqli_query($this->con,$sql);
        return $res;
    }    
